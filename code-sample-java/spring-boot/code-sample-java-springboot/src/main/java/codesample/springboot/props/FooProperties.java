package codesample.springboot.props;

import codesample.springboot.controller.HelloWorldController;
 ...
 * {@code @EnableConfigurationProperties(FooProperties.class) } in our main class {@link codesample.springboot.SpringBootRunner}.
 *
